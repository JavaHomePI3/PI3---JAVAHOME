        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary container-fluid">
                ...
                <div class="form-inline">
                    <li class="nav-item dropdown no-arrow mx-1" style="list-style: none;">
                    ...
                    <!-- Nav Item - Messages -->
                    <li class="nav-item dropdown no-arrow mx-1" style="list-style: none;">
                        <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="" aria-haspopup="true" aria-expanded="false">
